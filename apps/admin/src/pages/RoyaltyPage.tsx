...
export default function RoyaltyPage() {
  ...
  const statCards: {
    ...
    ? [
        {
          title: t("royalty:stats.monthlyTotal"),
          value: stats.monthlyTotal,
          suffix: t("royalty:stats.unit"),
          color: "var(--color-text-primary)",
        },
        {
          title: t("royalty:stats.pendingSettlement"),
          value: stats.pendingTotal,
          suffix: t("royalty:stats.unit"),
          color: "var(--color-feedback-warning)",
        },
        {
          title: t("royalty:stats.settled"),
          value: stats.settledTotal,
          suffix: t("royalty:stats.unit"),
          color: "var(--color-brand)",
        },
        {
          title: t("royalty:stats.withdrawn"),
          value: stats.withdrawnTotal,
          suffix: t("royalty:stats.unit"),
  ...
  const handleBatchSettle = () => {
    ...
    modal.confirm({
      ...
      onOk: async () => {
        ...
        message.success(
          t("royalty:message.settled", { count: pendingIds.length }),
        );
        setSelectedRowKeys([]);
        loadData();
      },
  ...
  const handleBatchWithdraw = () => {
    const settledIds = list
      .filter((r) => selectedRowKeys.includes(r.id) && r.status === "settled")
      .map((r) => r.id);
    ...
    modal.confirm({
      ...
      content: t("royalty:confirmWithdraw.content", {
      ...
      onOk: async () => {
        ...
        message.success(
          t("royalty:message.withdrawn", { count: settledIds.length }),
        );
        setSelectedRowKeys([]);
        loadData();
      },
