...
export function ShelveModal({ open, onClose, onConfirm, title }: ShelveModalProps) {
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 'var(--space-4)' }}>
        <div style={{ marginBottom: 'var(--space-2)', fontWeight: 500 }}>{t('novel:offline.reasonRequired')}</div>
        <Radio.Group value={shelveReason} onChange={(e) => setShelveReason(e.target.value)}>
      ...
      <div>
        <div style={{ marginBottom: 'var(--space-2)', fontWeight: 500 }}>{t('novel:offline.remark')}</div>
        <Input.TextArea
          value={shelveNote}
