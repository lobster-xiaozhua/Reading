...
interface BookDetailHeroProps {
  ...
  historyEntry?: { chapterId: string; chapterIndex: number; chapterTitle: string; percent: number } | null;
  onToggleShelf: () => void;
  onStartReading: () => void;
}
    ...
    <section className="book-detail__hero container-page">
      ...
      <div className="book-detail__meta">
        ...
        <div className="book-detail__actions">
          <Button variant="primary" size="lg" onClick={onStartReading} className="book-detail__read-btn">
