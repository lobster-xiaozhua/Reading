...
- Name: pages.b-end.ts >> B 端页面巡检 >> 控制台无重大错误
- Location: monitoring/checks/pages.b-end.ts:16:7
...
Call log:
  - navigating to "http://localhost:5174/login", waiting until "domcontentloaded"
