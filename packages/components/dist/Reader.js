...
import { LINE_HEIGHT_VALUE, FONT_FAMILY_VAR, THEME_VARS, } from "./useReaderSettings.js";
import { ReadingProgress } from "./ReadingProgress.js";
import { ReaderSettings } from "./ReaderSettings.js";
import { NavigationChevronLeft, NavigationChevronRight, NavigationMenu, SystemSettings, NovelMoon, NovelSun, NovelBookmark, NovelBookmarkFilled, } from "@novel/icons";
/* ============================================================
 * Reader
 * ============================================================ */
...
export function Reader({ chapter, loading = false, error = null, currentIndex, totalChapters, chapterPercent = 0, settings, onSettingsChange, onPrev, onNext, onSeek, onCatalog, onBack, onProgress, disableSeek = false, topBarExtra, isBookmarked = false, onBookmark, nextChapterTitle, nextChapterPreview, className, }) {
    ...
    const containerStyle = {
        ...
        ["--novel-read-bg"]: themeVars.bg,
        ["--novel-read-text"]: themeVars.text,
        ["--novel-read-text-secondary"]: themeVars.secondary,
    ...
    return (_jsxs("div", { className: rootCls, style: containerStyle, children: [_jsx("div", { className: "sr-only", role: "status", "aria-live": "polite", "aria-atomic": "true", children: chapter
                    ? `已加载章节：${chapter.title}${hasProgress
                    ...
                    : loading
                        ...
                        : "" }), hasProgress ? (_jsx(ReadingProgress, { current: currentIndex, total: totalChapters, percent: chapterPercent, onSeek: onSeek, disableSeek: disableSeek })) : null, loading ? (_jsx("div", { className: "novel-reader__loading-bar", role: "status", "aria-label": "\u7AE0\u8282\u52A0\u8F7D\u4E2D", children: _jsx("div", { className: "novel-reader__loading-bar-fill" }) })) : null, _jsx("div", { ref: contentRef, className: "novel-reader__content", style: contentStyle, onClick: handleContentClick, onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, onScroll: handleScroll, "aria-label": "\u7AE0\u8282\u6B63\u6587", children: _jsx("div", { className: "novel-reader__inner", children: error ? (_jsxs("div", { className: "novel-reader__error", role: "alert", children: [_jsx("p", { children: "\u7AE0\u8282\u52A0\u8F7D\u5931\u8D25" }), _jsx("p", { className: "novel-reader__error-detail", children: error.message }), _jsx("button", { type: "button", className: "novel-reader__nav-btn novel-reader__nav-btn--primary", onClick: () => {
                                ...
                                dangerouslySetInnerHTML: { __html: chapter.content } }), _jsxs("div", { className: "novel-reader__chapter-end", children: [_jsx("button", { type: "button", className: "novel-reader__nav-btn novel-reader__nav-btn--primary", onClick: onNext, disabled: !onNext, children: "\u4E0B\u4E00\u7AE0" }), _jsx("button", { type: "button", className: "novel-reader__nav-btn", onClick: onPrev, disabled: !onPrev, children: "\u4E0A\u4E00\u7AE0" })] }), nextChapterTitle ? (_jsxs("div", { className: "novel-reader__next-chapter-preview", children: [_jsxs("div", { className: "novel-reader__next-chapter-preview-label", children: [_jsx("span", { className: "novel-reader__next-chapter-preview-badge", children: "\u4E0B\u4E00\u7AE0" }), _jsx("span", { className: "novel-reader__next-chapter-preview-title", children: nextChapterTitle })] }), nextChapterPreview ? (_jsx("p", { className: "novel-reader__next-chapter-preview-text", children: nextChapterPreview })) : null, _jsx("button", { type: "button", className: "novel-reader__nav-btn novel-reader__nav-btn--primary", onClick: onNext, disabled: !onNext, children: "\u7ACB\u5373\u9605\u8BFB" })] })) : null] })) : loading ? (_jsx("div", { className: "novel-reader__placeholder", "aria-hidden": true })) : null }) }), settings.pageMode === "click" && chapter ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "novel-reader__tap-zone novel-reader__tap-zone--left", "aria-hidden": true }), _jsx("div", { className: "novel-reader__tap-zone novel-reader__tap-zone--right", "aria-hidden": true })] })) : null, _jsxs("div", { className: "novel-reader__topbar", "aria-hidden": !controlsVisible, children: [_jsx("button", { type: "button", className: "novel-reader__icon-btn", "aria-label": "\u8FD4\u56DE", onClick: onBack, children: _jsx(NavigationChevronLeft, { size: "lg", "aria-hidden": "true" }) }), _jsxs("div", { className: "novel-reader__topbar-title-wrap", children: [_jsx("div", { className: "novel-reader__topbar-chapter-num", children: currentIndex != null && totalChapters != null
                                    ...
                                    : "" }), _jsx("div", { className: "novel-reader__topbar-title", children: chapter?.title ?? "" }), _jsx("div", { className: "novel-reader__topbar-elapsed", children: formatElapsed(elapsedMs) })] }), _jsx("div", { className: "novel-reader__topbar-right", children: topBarExtra ?? (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", className: "novel-reader__icon-btn", "aria-label": isBookmarked ? "已收藏本章" : "收藏本章", onClick: toggleBookmark, children: isBookmarked ? (_jsx(NovelBookmarkFilled, { size: "lg", "aria-hidden": "true" })) : (_jsx(NovelBookmark, { size: "lg", "aria-hidden": "true" })) }), _jsx("button", { type: "button", className: "novel-reader__icon-btn", "aria-label": "\u9605\u8BFB\u8BBE\u7F6E", onClick: () => setSettingsVisible(true), children: _jsx(SystemSettings, { size: "lg", "aria-hidden": "true" }) })] })) })] }), _jsxs("div", { className: "novel-reader__bottombar", "aria-hidden": !controlsVisible, children: [_jsxs("button", { type: "button", className: "novel-reader__bar-btn", "aria-label": "\u4E0A\u4E00\u7AE0", onClick: onPrev, disabled: !onPrev, children: [_jsx(NavigationChevronLeft, { size: "lg", "aria-hidden": "true" }), _jsx("span", { children: "\u4E0A\u4E00\u7AE0" })] }), _jsxs("button", { type: "button", className: "novel-reader__bar-btn", "aria-label": "\u76EE\u5F55", onClick: onCatalog, children: [_jsx(NavigationMenu, { size: "lg", "aria-hidden": "true" }), _jsx("span", { children: "\u76EE\u5F55" })] }), _jsxs("button", { type: "button", className: "novel-reader__bar-btn", "aria-label": "\u9605\u8BFB\u8BBE\u7F6E", onClick: () => setSettingsVisible(true), children: [_jsx(SystemSettings, { size: "lg", "aria-hidden": "true" }), _jsx("span", { children: "\u8BBE\u7F6E" })] }), _jsxs("button", { type: "button", className: "novel-reader__bar-btn", "aria-label": isBookmarked ? "已收藏本章" : "收藏本章", onClick: toggleBookmark, children: [isBookmarked ? (_jsx(NovelBookmarkFilled, { size: "lg", "aria-hidden": "true" })) : (_jsx(NovelBookmark, { size: "lg", "aria-hidden": "true" })), _jsx("span", { children: "\u4E66\u7B7E" })] }), _jsxs("button", { type: "button", className: "novel-reader__bar-btn", "aria-label": settings.theme === "night" ? "切换日间" : "切换夜间", onClick: toggleNight, children: [settings.theme === "night" ? (_jsx(NovelSun, { size: "lg", "aria-hidden": "true" })) : (_jsx(NovelMoon, { size: "lg", "aria-hidden": "true" })), _jsx("span", { children: settings.theme === "night" ? "日间" : "夜间" })] }), _jsxs("button", { type: "button", className: "novel-reader__bar-btn", "aria-label": "\u4E0B\u4E00\u7AE0", onClick: onNext, disabled: !onNext, children: [_jsx(NavigationChevronRight, { size: "lg", "aria-hidden": "true" }), _jsx("span", { children: "\u4E0B\u4E00\u7AE0" })] })] }), _jsx(ReaderSettings, { settings: settings, onChange: onSettingsChange, visible: settingsVisible, onClose: () => setSettingsVisible(false) })] }));
}
