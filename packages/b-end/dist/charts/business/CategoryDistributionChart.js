...
export function CategoryDistributionChart({ data, topN = 6, height = CHART_DEFAULT_HEIGHT, emptyDescription, config, }) {
    const colors = useMemo(() => getChartColors(), []);
    const dark = isDarkMode();
    if (!data || data.length === 0) {
        return (_jsx(ChartWrapper, { empty: true, emptyDescription: emptyDescription ?? "暂无分类数据", height: height }));
    }
    // Top6 后合并「其他」
...
//# sourceMappingURL=CategoryDistributionChart.js.map