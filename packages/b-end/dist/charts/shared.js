...
/** 空数据占位（P7-5） */
export function renderChartEmpty(description = "暂无数据") {
    return (_jsx("div", { style: {
            height: CHART_DEFAULT_HEIGHT,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
        }, children: _jsx(Empty, { description: description }) }));
}
export function ChartWrapper({ empty, emptyDescription, height = CHART_DEFAULT_HEIGHT, children, }) {
    if (empty) {
        return (_jsx("div", { style: {
                height,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            }, children: _jsx(Empty, { description: emptyDescription ?? "暂无数据" }) }));
    }
    return _jsx("div", { style: { width: "100%", height }, children: children });
}
