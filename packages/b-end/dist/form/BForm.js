 ...
 */
export const BForm = forwardRef(({ layout = "vertical", validateTrigger = ["onBlur", "onChange"], scrollToFirstError = true, ...rest }, ref) => (_jsx(AntForm, { ref: ref, layout: layout, validateTrigger: validateTrigger, scrollToFirstError: scrollToFirstError, ...rest })));
