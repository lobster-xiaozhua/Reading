 ...
 * 文档：建议层级 ≤ 3 级。
 */
export const BCascader = forwardRef(({ changeOnSelect = true, showSearch = true, ...rest }, ref) => (_jsx(AntCascader, { ref: ref, changeOnSelect: changeOnSelect, showSearch: showSearch, ...rest })));
BCascader.displayName = "BCascader";
//# sourceMappingURL=BCascader.js.map