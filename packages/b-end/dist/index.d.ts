export declare const B_END_VERSION = "0.2.0";
...
export type { BAuthorManagerProps, AuthorInfo, AuthorWork, ContractInfo, RoyaltyStat, } from "./author-manager/BAuthorManager.js";
...
export type { PricingParams, PricingResult, BuyoutParams, ShareParams, GuaranteeShareParams, } from "./data-model/vip-pricing.js";
...
export type { SensitiveHit, FilterAction, ContentSegment, } from "./data-model/sensitive-filter.js";
