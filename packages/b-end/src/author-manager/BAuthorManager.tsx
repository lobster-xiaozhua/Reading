        ...
        <Card>
          ...
          >
            ...
            <div>
              ...
              >
                <span>
                  签约模式：{CONTRACT_TYPE_LABEL[author.contractType]}
                </span>
            ...
            <div style={{ marginLeft: "auto" }}>
              {author.contractStatus === "active" && (
                <Tag color="success">签约中</Tag>
              )}
              {author.contractStatus === "terminated" && (
                <Tag color="default">已解约</Tag>
              )}
              {author.contractStatus === "pending" && (
                <Tag color="warning">待签约</Tag>
              )}
            </div>
          </div>
        </Card>
            ...
            <Card title="收益统计">
              ...
              >
                ...
                <BStatisticCard
                  ...
                  trendText={
                    royalty.settlementStatus === "pending" ? "待结算" : "已结算"
                  }
                />
              </div>
            </Card>
