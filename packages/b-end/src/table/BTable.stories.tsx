...
export const Default: Story = { args: { columns, dataSource: data, rowKey: 'key' } };
export const Loading: Story = { args: { columns, dataSource: [], rowKey: 'key', loading: true } };
export const Empty: Story = { args: { columns, dataSource: [], rowKey: 'key' } };